    ...
    for(var p in obj){
        if(p.indexOf('Symbolizer')!==-1){
            if(p==='TextSymbolizer'){
                ...
                obj.TextSymbolizer["@placement-type"]="simple";
                obj.TextSymbolizer["@placements"]="NE,E,SE,W,N,SE,SW,S";
                ...
                for(var proper in obj.TextSymbolizer){
                    switch (proper){
                        ...
                        case 'symbol-placement':
                            ...
                            break;
                        case 'text-anchor':
                            // if (obj.TextSymbolizer[proper] == 'left') {
                            //     obj.TextSymbolizer['@horizontal-alignment'] ='right';
                            // }
                            // else if (obj.TextSymbolizer[proper] == 'right') {
                            //     obj.TextSymbolizer['@horizontal-alignment'] ='left';
                            // }
                            // else if (obj.TextSymbolizer[proper] == 'bottom') {
                            //     obj.TextSymbolizer['@vertical-alignment'] = "top";
                            // }
                            // else if ( obj.TextSymbolizer[proper] == 'top') {
                            //     obj.TextSymbolizer['@vertical-alignment'] = "bottom";
                            // }
                            ...
                            //     obj.TextSymbolizer['@horizontal-alignment'] = arr[1]=='left'?"right":"left";
                            //     obj.TextSymbolizer['@vertical-alignment'] = arr[0]=="bottom"?"top":"bottom";
                            // }
                            delete obj.TextSymbolizer[proper];
                            break;
                        case 'text-field':
                        ...
                        case 'text-font':
                           ...
                           // hack to have fontsets
                            obj.TextSymbolizer['@fontset-name'] = 'fontset-0';
                            delete obj.TextSymbolizer[proper];
                            break;
...
//                            obj.MarkersSymbolizer['@file'] = path.join(filedir,obj.MarkersSymbolizer[proper]).replace(/\\/g,'\/')+'.svg';
                            obj.MarkersSymbolizer['@file'] = "icons/"+ obj.MarkersSymbolizer[proper]+'.svg';
                            delete obj.MarkersSymbolizer[proper];
                            break;
                ...
                for(var proper in obj.ShieldSymbolizer){
                    switch (proper){
                        case 'symbol-placement':
                            ...
                            break;
                        case 'text-anchor':
                            if (obj.ShieldSymbolizer[proper] == 'left') {
                                obj.ShieldSymbolizer['@horizontal-alignment'] ='right';
                            }
                            else if (obj.ShieldSymbolizer[proper] == 'right') {
                                obj.ShieldSymbolizer['@horizontal-alignment'] ='left';
                            }
                            else if (obj.ShieldSymbolizer[proper] == 'bottom') {
                                obj.ShieldSymbolizer['@vertical-alignment'] = "top";
                            }
                            else if ( obj.ShieldSymbolizer[proper] == 'top') {
                                obj.ShieldSymbolizer['@vertical-alignment'] = "bottom";
                            }
                                ...
                                obj.ShieldSymbolizer['@horizontal-alignment'] = arr[1]=='left'?"right":"left";
                                obj.ShieldSymbolizer['@vertical-alignment'] = arr[0]=="bottom"?"top":"bottom";
                            }
                            delete obj.ShieldSymbolizer[proper];
                            break;
                        case 'text-field':
                        ...
                        case 'icon-image':
                            ...
                            obj.ShieldSymbolizer['@file'] = "icons/"+ obj.ShieldSymbolizer[proper]+'.svg';
                            delete obj.ShieldSymbolizer[proper];
                            break;
