    ...
    if (invisisble(layer)) {
        ...
        for (var p in gstyle) {
            ...
            if (p == 'line-pattern') {
                ...
                if (key !== '') {
                    line_symbol.LineSymbolizer[key] = mapping.colorConvert(gstyle[p]);
                }
            }
            count++;
            if (count >= counts) {
        ...
        for (var p in gstyle) {
            ...
            if (p == 'fill-outline-color' && gstyle['fill-outline-color']) {
                fill_symbol.LineSymbolizer = {
                    '@stroke': mapping.colorConvert(gstyle[p])
                }
            }
                ...
                if (key !== '') {
                    fill_symbol.PolygonSymbolizer[key] = mapping.colorConvert(gstyle[p]);
                }
            }
            count++;
            if (count >= counts) {
...
function symbolTranslate(layer) {
    ...
    for (var p in gstyle) {
        if (layer.shield) {
            ...
            if (key !== '') {
                symbolizer.ShieldSymbolizer[key] = mapping.colorConvert(gstyle[p]);
            }
        }
        else {
            //MarkersSymbolizer
            ...
            //TextSymbolizer
                ...
                if (key !== '') {
                    symbolizer.TextSymbolizer[key] = mapping.colorConvert(gstyle[p]);
                }
            }
        }
        count++;
    ...
    if (invisisble(layer)) {
        ...
        for (var p in gstyle) {
            if (p == 'circle-radius') {
                ...
                if (key !== '') {
                    symbolizer.MarkersSymbolizer[key] = mapping.colorConvert(gstyle[p]);
                }
            }
            count++;
            if (count >= counts) {
